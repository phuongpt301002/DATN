        ...
        <div class="col-12 col-lg-12 col-xxl-12 d-flex">
          <div class="card flex-fill">
            <div class="card-header">
              <h5 class="card-title mb-0">DANH SÁCH ĐĂNG KÝ HỌC PHẦN</h5>
            </div>

            <div class="row">
              <div class="col-12">
                <div class="button-container" style="position: absolute; top: 20px; right: 20px; bottom: 20px;">
                  <button class="btn btn-primary btn-lg" onclick="goToPageAdd_DKHP()">THÊM</button>
                </div>
                <script>
                  function goToPageAdd_DKHP() {
                    window.location.href = "pages_add_DKHP.php"; // Chuyển sang trang trang pages_add_DKHP.php
                  }
                </script>
            ...
            <table class="table table-hover my-0">
              <thead>
                <tr>
                  <th class="d-none d-md-table-cell">Mã đăng ký</th>
                  <th class="d-none d-md-table-cell">Mã số sinh viên</th>
                  <th class="d-none d-md-table-cell">Mã số học phần</th>
              ...
              <tbody>
                ...
                $sql1 = "SELECT dkhp.ID_DKHP, hocphan.ID_HOCPHAN, hocphan.TEN_HOCPHAN, sinhvien.ID_SV,
            CASE dkhp.TINHTRANG
                WHEN 1 THEN 'Đã xác nhận'
                WHEN 0 THEN 'Chờ xác nhận'
            END AS TINHTRANG,
            dkhp.HOCKY, dkhp.NAMHOC 
         FROM 
            dkhp
         JOIN 
            hocphan ON hocphan.ID_HOCPHAN = dkhp.ID_HOCPHAN
         LEFT JOIN 
            sinhvien ON sinhvien.ID_SV =  dkhp.ID_SV";
                ...
                if (mysqli_num_rows($result1) <> 0) {
                  ...
                  <td class="d-none d-xl-table-cell">' . $rows[3] . '</td>
                  ...
                  <td class="d-none d-xl-table-cell">' . $rows[6] . '</td>
                  <td class="d-none d-xl-table-cell">' . $rows[4] . '</td>
                  <td>
                    <a class="btn btn-success" href="pages_confirm_dkhp.php?ID_DKHP=' . $rows[0] . '&ID_SV=' . $rows[3]. '">Xác nhận</a>
                    <a class="btn btn-primary" href="pages_delete_dkhp.php?ID_DKHP=' . $rows[0] . '" onclick="return confirm(\'Bạn có chắc chắn muốn xóa học phần này?\');">Xóa</a>
                  </td>
                </tr>';
                  }
                }
