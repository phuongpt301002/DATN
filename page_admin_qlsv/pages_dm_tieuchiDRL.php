...
<head>
  ...
  <title>DANH MỤC TIÊU CHÍ ĐIỂM RÈN LUYỆN</title>
        ...
        <div class="col-12 col-lg-12 col-xxl-12 d-flex">
          <div class="card flex-fill">
            <div class="card-header">
              <h5 class="card-title mb-0">DANH SÁCH TIÊU CHÍ ĐIỂM RÈN LUYỆN</h5>
            </div>

            <div class="row">
              <div class="col-12">
                <div class="button-container" style="position: absolute; top: 20px; right: 20px; bottom: 20px;">
                  <button class="btn btn-primary btn-lg" onclick="goToPageAdd_TieuChiDRL()">THÊM</button>
                </div>
                <script>
                  function goToPageAdd_TieuChiDRL() {
                    window.location.href = "pages_add_tieuchiDRL.php"; // Chuyển sang trang trang pages_add_SV.php
                  }
                </script>
            ...
            <table class="table table-hover my-0">
              <thead>
                <tr>
                <th class="d-none d-md-table-cell">Mã tiêu chí</th>
                  <th class="d-none d-md-table-cell">Tên tiêu chí</th>
                  <th class="d-none d-md-table-cell">Điểm chuẩn</th>
              ...
              <tbody>
                ...
                $sql = "SELECT  tieuchi_drl.ID_TIEUCHI ,tieuchi_drl.TEN_TIEUCHI,  tieuchi_drl.DIEMCHUAN FROM tieuchi_drl";
                ...
                if (mysqli_num_rows($result) <> 0) {
                  ...
                  <td>
                  <a class="btn btn-primary" href="pages_edit_tieuchiDRL.php?ID_TIEUCHI=' . $rows[0] . '">Chỉnh sửa</a>
                    <a class="btn btn-primary" href="pages_delete_tieuchiDRL.php?ID_TIEUCHI=' . $rows[0] . '" onclick="return confirm(\'Bạn có chắc chắn muốn xóa sinh viên này?\');">Xóa</a>
                  </td>
                </tr>';
                  }
                }
