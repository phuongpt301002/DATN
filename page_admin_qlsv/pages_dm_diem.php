...
<body>
  ...
  <div class="wrapper">
    ...
    <div class="main">
        ...
        <div class="col-12 col-lg-12 col-xxl-12 d-flex">
          <div class="card flex-fill">
            <div class="card-header">
              <h5 class="card-title mb-0">DANH SÁCH KẾT QUẢ HỌC TẬP</h5>
            </div>
            ...
            <table class="table table-hover my-0">
              ...
              <tbody>
                ...
                $sql1 = "SELECT DISTINCT hocphan.ID_HOCPHAN, hocphan.TEN_HOCPHAN, dkhp.HOCKY, dkhp.NAMHOC, dkhp.ID_DKHP FROM dkhp
      ...
      <td>
      <a class="btn btn-primary" href="pages_show_diem.php?ID_DKHP=' . $rows[4] . '&ID_HOCPHAN=' . $rows[0] . '">Xem</a>
      </td>
    </tr>';
                  }
                }
