    ...
    if (isset($_SESSION['acc_cbnv']) && $_SESSION['acc_cbnv'] === true) {
        if (isset($_GET["ID_LOP"])) {
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['update'])) {
                ...
                $sql_update = "UPDATE tieuchi_drl SET ten_tieuchi = '$ten_tieuchi' , mota = '$mota' , diemchuan = '$diemchuan'
                    WHERE  ID_TIEUCHI = '$ID_TIEUCHI'";
                ...
                if ($result_update) {
                    ...
                    header('Location: ?ID_TIEUCHI=' . $ID_TIEUCHI . '');
                } else {
                    echo 'Error';
                }
            }
        ...
        <div class="main">
            ...
            <form class="content" method="post">
                <div class="container-fluid p-0">
                    <div class="mb-3">
                        <h1 class="h3 d-inline align-middle">CHỈNH SỬA THÔNG TIN TIÊU CHÍ ĐIỂM RÈN LUYỆN</h1>
                    </div>
                    <div class="row">
                        <div class="col-12 col-lg-6">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title mb-0">Chỉnh sửa thông tin tiêu chí điểm rèn luyện</h5>
                                </div>
                                <div class="card-body">
                                ...
                                <div class="card-body">
                                    ...
                                    <input type="text" name="ten_tieuchi" class="form-control" placeholder="Tên tiêu chí" required value="<?php if (isset($ten_tieuchi))
                                                                                                                                            echo $ten_tieuchi;
                                                                                                                                        ?>" />
                                </div>
                                <div class="card-body">
                                    <label class="form-label">Mô tả</label>
                                    <input type="text" name="mota" class="form-control" placeholder="Mô tả"  value="<?php if (isset($mota))
                                                                                                                                            echo $mota;
                                                                                                                                        ?>" />
                                </div>
                                <div class="card-body">
                                    <label class="form-label">Điểm chuẩn</label>
                                    <input type="number" name="diemchuan" class="form-control" placeholder="Điểm chuẩn" required value="<?php if (isset($diemchuan))
                                                                                                                                            echo $diemchuan;
                                                                                                                                        ?>" />
                                </div>
