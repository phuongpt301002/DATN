            ...
            <table class="table table-hover my-0">
              ...
              <tbody>
                ...
                if (isset($_GET['ID_LOP'])) {
                  ...
                  // Sử dụng prepared statements để tránh SQL injection
                  $sql = "SELECT sinhvien.ID_SV, sinhvien.HOTEN_SV, lop.ID_lop, sinhvien.NGAYSINH 
            FROM 
                sinhvien
            JOIN 
                lop ON lop.ID_LOP = sinhvien.ID_LOP
            WHERE 
                lop.ID_LOP = ?";
                  ...
                  if ($stmt = mysqli_prepare($conn, $sql)) {
                    ...
                    if (mysqli_num_rows($result1) > 0) {
                      ...
                      <td>
                      <a class="btn btn-primary" href="pages_delete_CTDT.php?ID_CTDT=' . htmlspecialchars($rows[0]) .  '">Chỉnh sửa</a>
                        <a class="btn btn-primary" href="pages_delete_CTDT.php?ID_CTDT=' . htmlspecialchars($rows[0]) . '" onclick="return confirm(\'Bạn có chắc chắn muốn xóa sinh viên này?\');">Xóa</a>
                      </td>
                    </tr>';
                      }
                    } else {
