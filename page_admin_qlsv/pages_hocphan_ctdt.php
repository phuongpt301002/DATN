...
<head>
  ...
  <title>HỌC PHẦN THEO CHƯƠNG TRÌNH ĐÀO TẠO</title>
        ...
        <div class="col-12 col-lg-12 col-xxl-12 d-flex">
          <div class="card flex-fill">
            <div class="card-header">
              <h5 class="card-title mb-0">DANH SÁCH CHƯƠNG TRÌNH ĐÀO TẠO</h5>
            </div>

            <div class="row">
              <div class="col-12">
                <div class="button-container" style="position: absolute; top: 20px; right: 20px; bottom: 20px;">
                  <button class="btn btn-primary btn-lg" onclick="goToPageAdd_CTDT()">THÊM</button>
                </div>
                <script>
                  function goToPageAdd_CTDT() {
                    window.location.href = "pages_add_CTDT.php"; // Chuyển sang trang trang pages_add_SV.php
                  }
                </script>
            ...
            <table class="table table-hover my-0">
              <thead>
                <tr>
                  <th class="d-none d-md-table-cell">Mã chương trình đào tạo</th>
                  <th class="d-none d-md-table-cell">Tên chương trình đào tạo</th>
                  <th class="d-none d-md-table-cell">Tên ngành</th>
              ...
              <tbody>
                ...
                $sql = "SELECT ctdt.ID_CTDT, ctdt.TEN_CTDT, nganh.TEN_NGANH FROM ctdt
                JOIN nganh ON ctdt.ID_NGANH = nganh.ID_NGANH";
                ...
                if (mysqli_num_rows($result) <> 0) {
                  ...
                  <td>
                  <a class="btn btn-primary" href="pages_detail_ctdt.php?ID_CTDT=' . $rows[0] . '">Xem</a>
                  <a class="btn btn-primary" href="pages_edit_CTDT.php?ID_CTDT=' . $rows[0] . '">Chỉnh sửa</a>
                    <a class="btn btn-primary" href="pages_delete_CTDT.php?ID_CTDT=' . $rows[0] . '" onclick="return confirm(\'Bạn có chắc chắn muốn xóa sinh viên này?\');">Xóa</a>
                  </td>
                </tr>';
                  }
                }
