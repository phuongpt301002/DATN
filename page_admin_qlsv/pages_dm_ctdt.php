...
<head>
  ...
  <title>DANH MỤC CHƯƠNG TRÌNH ĐÀO TẠO</title>
            ...
            <table class="table table-hover my-0">
              ...
              <tbody>
                ...
                if (mysqli_num_rows($result) <> 0) {
                  ...
                  <td>
                  <a class="btn btn-primary" href="pages_edit_dm_ctdt.php?ID_CTDT=' . $rows[0] . '">Chỉnh sửa</a>
                    <a class="btn btn-primary" href="pages_delete_dm_ctdt.php?ID_CTDT=' . $rows[0] . '" onclick="return confirm(\'Bạn có chắc chắn muốn xóa sinh viên này?\');">Xóa</a>
                  </td>
                </tr>';
                  }
                }
