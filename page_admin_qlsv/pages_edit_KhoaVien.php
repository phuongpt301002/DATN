...
<body>
    ...
    if (isset($_SESSION['acc_cbnv']) && $_SESSION['acc_cbnv'] === true) {
        if (isset($_GET["ID_KHOAVIEN"])) {
            ...
            $sql1 = "SELECT * FROM khoa_vien
                WHERE khoa_vien.ID_KHOAVIEN = '$ID_KHOAVIEN'";
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['update'])) {
                ...
                $sql_update = "UPDATE khoa_vien SET ten_khoavien = '$ten_khoavien'
                    WHERE  ID_KHOAVIEN = '$ID_KHOAVIEN'";
                ...
                if ($result_update) {
                    ...
                    header('Location: ?ID_KHOAVIEN=' . $ID_KHOAVIEN . '');
                } else {
                    echo 'Error';
                }
            }
                        ...
                        <div class="col-12 col-lg-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <input type="text" name="ten_khoavien" class="form-control" placeholder="Tên khoa viện" required value="<?php if (isset($ten_khoavien))
                                                                                                                                            echo $ten_khoavien;
                                                                                                                                        ?>" />
                                </div>
                            </div>
