...
<head>
    ...
    <title>SỬA THÔNG TIN CHƯƠNG TRÌNH ĐÀO TẠO</title>
...
<body>
    ...
    if (isset($_SESSION['acc_cbnv']) && $_SESSION['acc_cbnv'] === true) {
        if (isset($_GET["ID_CTDT"])) {
            ...
            $sql1 = "SELECT * FROM ctdt 
                JOIN nganh ON ctdt.ID_nganh = nganh.ID_NGANH
                WHERE ctdt.ID_CTDT = '$ID_CTDT'";
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['update'])) {
                ...
                $sql_update = "UPDATE ctdt SET ten_CTDT = '$ten_CTDT', id_nganh ='$id_nganh'
                    WHERE  ID_CTDT = '$ID_CTDT'";
                ...
                if ($result_update) {
                    ...
                    header('Location: ?ID_CTDT=' . $ID_CTDT . '');
                } else {
                    echo 'Error';
                }
            }
        ...
        <div class="main">
            ...
            <form class="content" method="post">
                <div class="container-fluid p-0">
                    <div class="mb-3">
                        <h1 class="h3 d-inline align-middle">CHỈNH SỬA THÔNG TIN CHƯƠNG TRÌNH ĐÀO TẠO</h1>
                    </div>
                    <div class="row">
                        <div class="col-12 col-lg-6">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title mb-0">Chỉnh sửa thông tin chương trình đào tạo</h5>
                                </div>
                                <div class="card-body">
                                ...
                                <div class="card-body">
                                    ...
                                    <input type="text" name="ten_CTDT" class="form-control" placeholder="Tên chương trình đào tạo" required value="<?php if (isset($ten_CTDT))
                                                                                                                                            echo $ten_CTDT;
                                                                                                                                        ?>" />
                                </div>
                                <div class="card-body">
