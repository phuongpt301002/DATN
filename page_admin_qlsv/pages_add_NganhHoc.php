...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["add_nganhhoc"])) {
        $id_nganh = $_POST["id_nganh"];
        $ten_nganh = $_POST["ten_nganh"];
        $id_khoavien = $_POST["id_khoavien"];

        $sql_add_nganhhoc = "INSERT INTO `nganh` (`id_nganh`, `ten_nganh`, `id_khoavien`) VALUES ('$id_nganh', '$ten_nganh', '$id_khoavien')";

        if (mysqli_query($conn, $sql_add_nganhhoc)) {
            echo "<script>
              setTimeout(function(){
            ...
            echo "Error: " . $sql_add_nganhhoc . mysqli_error($conn);
        }
    }
    ?>
    <?php
          ...
          <div class="nav-item dropdown">
            ...
            <form class="content" method="post">
                <div class="container-fluid p-0">
                    <div class="mb-3">
                        <h1 class="h3 d-inline align-middle">THÊM NGÀNH HỌC</h1>
                    </div>
                    <div class="row">
                        <div class="col-12 col-lg-6">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title mb-0">Thêm ngành học</h5>
                                </div>
                                <div class="card-body">
                                    <label class="form-label">Mã ngành học</label>
                                    <input type="text" name="id_nganh" class="form-control" placeholder="Mã ngành học" required value="<?php
                                                                                                                                        if (isset($id_nganhhoc)) echo $id_nganhhoc;
                                                                                                                                        ?>" />
                                </div>
                                <div class="card-body">
                                    <label class="form-label">Tên ngành học</label>
                                    <input type="text" name="ten_nganh" class="form-control" placeholder="Tên ngành học" required value="<?php
                                                                                                                                            if (isset($ten_nganhhoc)) echo $ten_nganhhoc;
                                                                                                                                            ?>" />
                                </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <select class="form-select" name="id_khoavien" required>
                                        <?php
                                        $sqlnganh = "SELECT * FROM khoa_vien";
                                ...
                                <div class="card-body">
                                    <input type="submit" name="add_nganhhoc" class="btn btn-success" value="THÊM NGÀNH HỌC" />
                                </div>
                            </div>
                        </div>
                    </div>
