  ...
  <div class="wrapper">
    ...
    <div class="main">
      ...
      <main class="content">
        <div class="col-12 col-lg-12 col-xxl-12 d-flex">
          <div class="card flex-fill">
            <div class="card-header">
              <h5 class="card-title mb-0">DANH SÁCH SINH VIÊN TỐT NGHIỆP</h5>
            </div>
            ...
            <table class="table table-hover my-0">
              ...
              <tbody>
                ...
                $sql = "SELECT sinhvien.ID_SV, sinhvien.HOTEN_SV, sinhvien.ID_LOP, nganh.TEN_NGANH, khoa_vien.TEN_KHOAVIEN, sinhvien.TINHTRANG
        FROM sinhvien
        ...
        WHERE sinhvien.TINHTRANG = 'Đã tốt nghiệp'";
              ...
              <td class="d-none d-xl-table-cell">' . htmlspecialchars($row['TINHTRANG']) . '</td>
