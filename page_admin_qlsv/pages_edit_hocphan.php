...
<head>
    ...
    <title>SỬA THÔNG TIN HỌC PHẦN</title>
...
<body>
    ...
    if (isset($_SESSION['acc_cbnv']) && $_SESSION['acc_cbnv'] === true) {
        if (isset($_GET["ID_HOCPHAN"])) {
            ...
            $sql1 = "SELECT * FROM hocphan
                WHERE hocphan.ID_HOCPHAN = '$ID_HOCPHAN'";
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['update'])) {
                ...
                $sql_update = "UPDATE hocphan SET ten_hocphan = '$ten_hocphan', tinchi ='$soTC'
                ...
                if ($result_update) {
                    ...
                    header('Location: ?ID_HOCPHAN=' . $ID_HOCPHAN . '');
                } else {
                    echo 'Error';
                }
            }
        ...
        <div class="main">
            ...
            <form class="content" method="post">
                <div class="container-fluid p-0">
                    <div class="mb-3">
                        <h1 class="h3 d-inline align-middle">CHỈNH SỬA THÔNG TIN HỌC PHẦN</h1>
                    </div>
                    <div class="row">
                        <div class="col-12 col-lg-6">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title mb-0">Chỉnh sửa thông tin học phần</h5>
                                </div>
                                <div class="card-body">
                                ...
                                <div class="card-body">
                                    ...
                                    <input type="text" name="ten_hocphan" class="form-control" placeholder="Tên học phần" required value="<?php if (isset($ten_hocphan))
                                                                                                                                            echo $ten_hocphan;
                                                                                                                                        ?>" />
                                </div>
                                <div class="card-body">
                ...
                <div class="container-fluid">
                    <div class="row text-muted">
                        <div class="col-6 text-start">
                            <p class="mb-0">
                                <a class="text-muted" href="https://ntu.edu.vn/" target="_blank"><strong>QUẢN LÝ QUÁ TRINHD HỌC TẬP CỦA SINH VIÊN</strong></a>
                                &copy;
                            </p>
                        </div>
                    </div>
