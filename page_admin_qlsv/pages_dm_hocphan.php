            ...
            <div class="row">
              <div class="col-12">
                <div class="button-container" style="position: absolute; top: 20px; right: 20px; bottom: 20px;">
                  <button class="btn btn-primary btn-lg" onclick="goToPageAdd_HOCPHAN()">THÊM</button>
                </div>
                <script>
                  function goToPageAdd_HOCPHAN() {
                    window.location.href = "pages_add_hocphan.php"; // Chuyển sang trang trang pages_add_SV.php
                  }
                </script>
            ...
            <table class="table table-hover my-0">
              <thead>
                <tr>
                  ...
                  <th class="d-none d-md-table-cell">Số tín chỉ</th>
              ...
              <tbody>
                ...
                $sql = "SELECT hocphan.ID_HOCPHAN, hocphan.TEN_HOCPHAN, hocphan.TINCHI FROM hocphan";
                ...
                if (mysqli_num_rows($result) <> 0) {
                  ...
                  <td>
                  <a class="btn btn-primary" href="pages_edit_hocphan.php?ID_HOCPHAN=' . $rows[0] . '">Chỉnh sửa</a>
                    <a class="btn btn-primary" href="pages_delete_hocphan.php?ID_HOCPHAN=' . $rows[0] . '" onclick="return confirm(\'Bạn có chắc chắn muốn xóa học phần này?\');">Xóa</a>
                  </td>
                </tr>';
                  }
                }
