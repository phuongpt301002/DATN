...
<head>
  ...
  <title>DANH MỤC KHOA VIỆN</title>
        ...
        <div class="col-12 col-lg-12 col-xxl-12 d-flex">
          <div class="card flex-fill">
            <div class="card-header">
              <h5 class="card-title mb-0">DANH SÁCH KHOA VIỆN</h5>
            </div>

            <div class="row">
              <div class="col-12">
                <div class="button-container" style="position: absolute; top: 20px; right: 20px; bottom: 20px;">
                  <button class="btn btn-primary btn-lg" onclick="goToPageAdd_KHOAVIEN()">THÊM</button>
                </div>
                <script>
                  function goToPageAdd_KHOAVIEN() {
                    window.location.href = "pages_add_KhoaVien.php"; // Chuyển sang trang trang pages_add_SV.php
                  }
                </script>
            ...
            <table class="table table-hover my-0">
              <thead>
                <tr>
                  <th class="d-none d-md-table-cell">Tên khoa viện</th>
              ...
              <tbody>
                ...
                $sql = "SELECT khoa_vien.ID_KHOAVIEN, khoa_vien.TEN_KHOAVIEN FROM khoa_vien";
                ...
                if (mysqli_num_rows($result) <> 0) {
                  ...
                  <td>
                  <a class="btn btn-primary" href="pages_edit_KhoaVien.php?ID_KHOAVIEN=' . $rows[0] . '">Chỉnh sửa</a>
                    <a class="btn btn-primary" href="pages_delete_KhoaVien.php?ID_KHOAVIEN=' . $rows[0] . '" onclick="return confirm(\'Bạn có chắc chắn muốn xóa sinh viên này?\');">Xóa</a>
                  </td>
                </tr>';
                  }
                }
