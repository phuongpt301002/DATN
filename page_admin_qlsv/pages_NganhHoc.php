...
<head>
  ...
  <title>DANH MỤC NGÀNH HỌC</title>
          ...
          <div class="card flex-fill">
            ...
            <div class="row">
              <div class="col-12">
                <div class="button-container" style="position: absolute; top: 20px; right: 20px; bottom: 20px;">
                  <button class="btn btn-primary btn-lg" onclick="goToPageAdd_NganhHoc()">THÊM</button>
                </div>
                <script>
                  function goToPageAdd_NganhHoc() {
                    window.location.href = "pages_add_Nganhhoc.php"; // Chuyển sang trang trang pages_add_SV.php
                  }
                </script>
            ...
            <table class="table table-hover my-0">
              ...
              <tbody>
                ...
                $sql = "SELECT nganh.ID_NGANH, nganh.TEN_NGANH FROM nganh";
                ...
                if (mysqli_num_rows($result) <> 0) {
                  ...
                  <td>
                  <a class="btn btn-primary" href="pages_edit_NganhHoc.php?ID_NGANH=' . $rows[0] . '">Chỉnh sửa</a>
                    <a class="btn btn-primary" href="pages_delete_NganhHoc.php?ID_NGANH=' . $rows[0] . '" onclick="return confirm(\'Bạn có chắc chắn muốn xóa sinh viên này?\');">Xóa</a>
                  </td>
                </tr>';
                  }
                }
