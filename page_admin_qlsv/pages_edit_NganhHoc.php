    ...
    if (isset($_SESSION['acc_cbnv']) && $_SESSION['acc_cbnv'] === true) {
        if (isset($_GET["ID_NGANH"])) {
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['update'])) {
                ...
                $sql_update = "UPDATE nganh 
               INNER JOIN khoa_vien ON khoa_vien.ID_KHOAVIEN = nganh.ID_KHOAVIEN
               SET nganh.ten_nganh = '$ten_nganh', nganh.ID_KHOAVIEN = '$ID_KHOAVIEN'
               WHERE nganh.ID_NGANH = '$ID_NGANH'";
                ...
                if ($result_update) {
                    ...
                    header('Location: ?ID_NGANH=' . $ID_NGANH . '');
                } else {
                    echo 'Error';
                }
            }
        ...
        <div class="main">
            ...
            <form class="content" method="post">
                <div class="container-fluid p-0">
                    <div class="mb-3">
                        <h1 class="h3 d-inline align-middle">CHỈNH SỬA THÔNG TIN NGÀNH HỌC</h1>
                    </div>
                    <div class="row">
                        <div class="col-12 col-lg-6">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title mb-0">Chỉnh sửa thông tin ngành học</h5>
                                </div>
                                <div class="card-body">
                                    <label class="form-label">Mã ngành</label>
                                    <input type="text" name="ID_NGANH" class="form-control" placeholder="Mã ngành" required value="<?php
                                                                                                                                        if (isset($ID_NGANH)) echo $ID_NGANH;
                                                                                                                                        ?>" />
                                </div>
                                <div class="card-body">
                                    <label class="form-label">Tên ngành</label>
                                    <input type="text" name="ten_nganh" class="form-control" placeholder="Tên ngành" required value="<?php if (isset($ten_nganh))
                                                                                                                                            echo $ten_nganh;
                                                                                                                                        ?>" />
                                </div>
                                <div class="card-body">
