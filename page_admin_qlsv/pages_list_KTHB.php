                ...
                <div class="col-12 col-lg-12 col-xxl-12 d-flex">
                    <div class="card flex-fill">
                        <div class="card-header">
                            <h5 class="card-title mb-0">DANH SÁCH KHEN THƯỞNG HỌC BỔNG</h5>
                        </div>

                        <div class="row">
                            <div class="col-12">
                                <div class="button-container" style="position: absolute; top: 20px; right: 20px; bottom: 20px;">
                                    <button class="btn btn-primary btn-lg" onclick="goToPageAdd_List_KTHB()">THÊM</button>
                                </div>
                                <script>
                                    function goToPageAdd_List_KTHB() {
                                        window.location.href = "pages_add_list_KTHB.php"; // Chuyển sang trang trang pages_add_SV.php
                                    }
                                </script>
                        ...
                        <table class="table table-hover my-0">
                            ...
                            <tbody>
                                ...
                                $sql = "SELECT sinhvien_kthb.ID_SV_KTHB, kthb.TEN_KTHB, sinhvien.ID_SV, sinhvien.HOTEN_SV,
                                sinhvien_kthb.HOCKY , sinhvien_kthb.NAMHOC 
                                FROM sinhvien_kthb
                                JOIN sinhvien ON sinhvien.ID_SV = sinhvien_kthb.ID_SV 
                                JOIN kthb ON kthb.ID_KTHB = sinhvien_kthb.ID_KTHB
                                ";
                  ...
                  <td>
                    <a class="btn btn-primary" href="pages_delete_list_KTHB.php?ID_SV_KTHB=' . $rows[0] . '" onclick="return confirm(\'Bạn có chắc chắn muốn xóa học phần này?\');">Xóa</a>
                  </td>
                </tr>';
                                    }
                                }
