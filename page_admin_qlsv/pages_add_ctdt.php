...
<body>
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["add_ctdt"])) {
    $id_CTDT = $_POST["id_CTDT"];
    $ten_CTDT = $_POST["ten_CTDT"];
    $id_nganh = $_POST["id_nganh"];

    $sql_add_ctdt = "INSERT INTO `ctdt` (`ID_CTDT`, `TEN_CTDT`, `ID_NGANH`) VALUES ('$id_CTDT', '$ten_CTDT', '$id_nganh')";

    if (mysqli_query($conn, $sql_add_ctdt)) {
      echo "<script>
              setTimeout(function(){
                  alert('Thêm chương trình đào tạo thành công');
                  window.location.href = 'pages_hocphan_ctdt.php';
              }, 0);
          </script>";
    } else {
      echo "Error: " . $sql_add_ctdt . mysqli_error($conn);
    }
  }
  ?>
  <div class="wrapper">
    ...
    <div class="main">
      ...
      <form class="content" method="post">
        <div class="container-fluid p-0">
          <div class="mb-3">
            <h1 class="h3 d-inline align-middle">THÊM CHƯƠNG TRÌNH ĐÀO TẠO</h1>
          </div>
          <div class="row">
            <div class="col-12 col-lg-6">
              <div class="card">
                <div class="card-header">
                  <h5 class="card-title mb-0">Thêm chương trình đào tạo</h5>
                </div>
                <div class="card-body">
                ...
                <div class="card-body">
                  ...
                  <input type="text" name="ten_CTDT" class="form-control" placeholder="Tên chương trình đào tạo" required value="<?php
                                                                                                                                  if (isset($ten_CTDT)) echo $ten_CTDT;
                                                                                                                                  ?>" />
                </div>
                ...
                <div class="card-body">
                  <input type="submit" name="add_ctdt" class="btn btn-success" value="THÊM CHƯƠNG TRÌNH ĐÀO TẠO" />
                </div>
              </div>
            </div>
          </div>
