        ...
        <div class="col-12 col-lg-12 col-xxl-12 d-flex">
          <div class="card flex-fill">
            ...
            <div class="row">
              <div class="col-12">
                <div class="button-container" style="position: absolute; top: 20px; right: 20px; bottom: 20px;">
                  <button class="btn btn-primary btn-lg" onclick="goToPageAdd_Lop()">THÊM</button>
                </div>
                <script>
                  function goToPageAdd_Lop() {
                    window.location.href = "pages_add_Lop.php"; // Chuyển sang trang trang pages_add_SV.php
                  }
                </script>
            ...
            <table class="table table-hover my-0">
              <thead>
                <tr>
                  <th class="d-none d-md-table-cell">Mã lớp</th>
              ...
              <tbody>
                ...
                $sql = "SELECT lop.ID_LOP FROM lop";
                ...
                if (mysqli_num_rows($result) <> 0) {
                  ...
                  <td>
                  <a class="btn btn-primary" href="pages_list_lop.php?ID_LOP=' . $rows[0] . '">Xem</a>
                  <a class="btn btn-primary" href="pages_edit_lop.php?ID_LOP=' . $rows[0] . '">Chỉnh sửa</a>
                    <a class="btn btn-primary" href="pages_delete_lop.php?ID_LOP=' . $rows[0] . '" onclick="return confirm(\'Bạn có chắc chắn muốn xóa sinh viên này?\');">Xóa</a>
                  </td>
                </tr>';
                  }
                }
